...
if submitted:
    ...
    # RAW features ONLY (must match training data)
    ...
    st.write(f"**Insurance Status:** {status_label}")
    st.write(f"**Approval Probability:** {pred_proba * 100:.2f}%")
